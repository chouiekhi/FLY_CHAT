...
import 'package:fly/group_chats/add_members.dart';
            ...
            builder: (context) {
              return AlertDialog(
                content: ListTile(
                  ...
                  title: const Text("Eliminar esta miembro"),
                ),
              );
            });
      }
  ...
  Future onLeaveGroup() async {
    if (checkAdmin() || !checkAdmin()) {
      ...
      Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (_) => HomeScreen(toString())),
        (route) => false,
      );
    }
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      leading: const Icon(
                        Icons.logout,
                        color: Color.fromARGB(255, 86, 53, 187),
                      ),
                      title: Text(
                        "Eliminar grupo",
                        style: TextStyle(
                          fontSize: size.width / 22,
                          fontWeight: FontWeight.w500,
                          color: Color.fromARGB(255, 81, 14, 189),
                        ),
                      ),
                    ),
                  ],
